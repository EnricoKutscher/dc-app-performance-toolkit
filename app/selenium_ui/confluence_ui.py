...
from extension.confluence.selenium_pmc import macro_actions, blueprint_actions
...
def test_1_selenium_pmc_macro_actions(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    macro_actions.pmc_macros(confluence_webdriver, confluence_datasets)

def test_1_selenium_pmc_blueprint_actions(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    blueprint_actions.blueprint_load_test(confluence_webdriver, confluence_datasets)  
